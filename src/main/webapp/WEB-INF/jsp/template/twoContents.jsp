...
<body>
	<div id="wrap">
		<header>
			<jsp:include page="../include/${type}/header.jsp"></jsp:include>
		</header>
		<section class="d-flex">
			<div class="contents d-flex justify-content-between">
				<div class="content">
					<jsp:include page="../include/${type}/${leftViewName}.jsp"></jsp:include>
				</div>
				<div class="content">
					<jsp:include page="../include/${type}/${rightViewName}.jsp"></jsp:include>
				</div>
			</div>
		</section>
	</div>
